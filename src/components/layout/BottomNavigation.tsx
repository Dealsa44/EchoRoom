...
const BottomNavigation = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 glass border-t border-border-soft/50 shadow-large z-30 backdrop-blur-lg">
      <div className="flex items-center justify-around py-2 px-3 max-w-md mx-auto" style={{ paddingBottom: 'calc(env(safe-area-inset-bottom, 0px) + 0.5rem)', paddingTop: '0.5rem' }}>
