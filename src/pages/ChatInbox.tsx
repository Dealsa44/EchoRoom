...
const ChatInbox = () => {
  ...
  return (
    <div className="h-screen app-gradient-bg relative overflow-hidden">
      ...
      <div className="h-full overflow-y-auto overscroll-behavior-contain -webkit-overflow-scrolling-touch px-4 py-6 max-w-md mx-auto space-y-6 relative z-10 pt-16">
        {/* Search with Menu */}
